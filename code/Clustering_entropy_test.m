...
mean_acc_en = zeros(nSimulations,1);
mean_acc_bs = zeros(nSimulations,1);
...
for ns = 1:nSimulations
    ...
    mean_acc_en(ns) = accuracy_entropy;
    mean_acc_bs(ns) = accuracy_baseline;
end

mean_acc_en = mean(mean_acc_en);
mean_acc_bs = mean(mean_acc_bs);
